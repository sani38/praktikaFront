    ...
    return (
        <header className="w-full border-b border-black/5 bg-white">
            <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
                <Link
                    to="/student"
                    className="text-[14px] text-black/70 hover:text-black/80 transition"
                >
                    Лого
                </Link>
...
function StudentNav() {
    ...
    const items = [
        { to: "/student/internships", label: "Поиск практики" },
        { to: "/student/applications", label: "Мои заявки" },
        { to: "/student/employers", label: "Работодатели" },
        { to: "/student/contracts", label: "Мои договоры" },
        { to: "/student/resume", label: "Создать резюме" },
        { to: "/student/diary", label: "Дневник практики" },
    ];
                ...
                <nav className="flex items-center justify-center gap-10">
                    {items.map((x) => (
                        <NavLink
                            ...
                            end={x.to === "/student"} // ссылку на кабинет
                        >
                            {x.label}
                        </NavLink>
                    ))}
            ...
            <div className="mx-auto max-w-6xl px-6">
                <div className="grid grid-cols-12 gap-6 py-12">
                    <div className="col-span-12 md:col-span-5">
                        ...
                        <p className="mt-4 max-w-md text-[12px] leading-6 text-black/45">
                            Единый портал практики и стажировок для студентов и выпускников в
                            Казахстане.
                        </p>
                    </div>
                    ...
                    <div className="col-span-12 md:col-span-3">
                        ...
                        <div className="mt-4 space-y-2 text-[12px] text-black/45">
                            <div>г. Алматы</div>
                            <a
                                href="mailto:info@praktika.kz"
                                className="block hover:text-black/70 transition"
                            >
                                info@praktika.kz
                            </a>
                            <a
                                href="tel:+77271234556"
                                className="block hover:text-black/70 transition"
                            >
                                +7 (727) 12-34-56
                            </a>
                ...
                <div className="flex flex-col gap-3 border-t border-black/5 py-6 md:flex-row md:items-center md:justify-between">
                    <div className="text-[12px] text-black/40">
                        © 2025 Практика. Все права защищены.
                    </div>
