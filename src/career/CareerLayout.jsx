    ...
    return (
        <header className="w-full border-b border-black/5 bg-white">
            <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
                <Link to="/career" className="text-[14px] text-black/70 hover:text-black/80 transition">
                    Лого
                </Link>
        ...
        <div className="w-full border-b border-black/5 bg-white">
            <div className="mx-auto max-w-6xl px-6">
                <nav className="flex items-center justify-center gap-16">
                    <NavLink to="/career/students" className={({ isActive }) => `${base} ${isActive ? active : ""}`}>
                        Студенты
                    </NavLink>
                    <NavLink to="/career/employers" className={({ isActive }) => `${base} ${isActive ? active : ""}`}>
                        Работодатели
                    </NavLink>
                    <NavLink to="/career/contracts" className={({ isActive }) => `${base} ${isActive ? active : ""}`}>
                        Договора
                    </NavLink>

                    <NavLink to="/career/diary" className={({ isActive }) => `${base} ${isActive ? active : ""}`}>
                        Дневник практики
                    </NavLink>
                </nav>
            </div>
